      ...
      <div class="grid grid-cols-1 md:grid-cols-2 h-full">
        ...
        <div bind:this={detailsRef} class="relative p-8 md:p-12 flex flex-col justify-between bg-[#0a0a0a] overflow-y-auto max-h-[50vh] md:max-h-[90vh] opacity-0">
          <div>
            ...
            <h2 class="mt-4 text-3xl md:text-4xl font-extralight tracking-tight text-white">
              {product.name}
            </h2>
                ...
                {#each product.colors as color, index}
                  <button
                    ...
                    class={cn(
                      ...
                      selectedColor === index ? 'border-white scale-110' : 'border-transparent hover:scale-105'
                    )}
                    title={color.name}
                  >
            ...
            <div class="mb-8">
              <div class="flex items-center justify-between mb-4">
                ...
                <button class="text-[10px] tracking-wider text-white/40 hover:text-white underline transition-colors cursor-pointer">
                  Size Guide
                </button>
              </div>
            ...
            <div class="mb-8">
              ...
              <div class="inline-flex items-center border border-white/20">
                ...
                <span class="w-16 h-12 flex items-center justify-center text-lg font-light border-x border-white/20 text-white">
                  {quantity}
                </span>
                <button
                  onclick={() => quantity++}
          ...
          <div class="space-y-4 pt-4 border-t border-white/10 mt-auto">
            ...
            <div class="flex gap-2">
              <button class="flex-1 h-12 border border-white/10 text-[10px] tracking-[0.2em] uppercase text-white/50 hover:text-white hover:border-white/30 transition-all cursor-pointer">
                Wishlist
              </button>
              <button class="flex-1 h-12 border border-white/10 text-[10px] tracking-[0.2em] uppercase text-white/50 hover:text-white hover:border-white/30 transition-all cursor-pointer">
                Share
